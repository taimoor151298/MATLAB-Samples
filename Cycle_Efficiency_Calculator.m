function [P_fromHEX, cycle_efficiency] = Cycle_Efficiency_Calculator(T_inlet, power_steamcycle)
...
T3 = T_inlet;     %Temperature in Kelvin
...
m_steam =  power_steamcycle/((h3 - h4)*eta_shaft*eta_gen); %Mass Flow Rate of Steam
...
cycle_efficiency = power_steamcycle/P_fromHEX;
